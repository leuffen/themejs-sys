...
<ul class="list-check list-bold">
    <li><strong>Moderne Website für Ihre Arztpraxis schon ab 59 Euro pro Monat</strong></li>
    <li><strong>Inklusive wichtige Funktionen</strong> (z. B. Online- Terminbuchung, E-Rezept & Videosprechstunde)</li>
    <li><strong>Keine Einmalkosten jederzeit kündbar</strong></li>
    <li><strong>Einfachste Handhabung</strong> für Ärzte und MFAs</li>
</ul>
...
Wir garantieren Ihnen 100% Zufriedenheit mit unserer <br class="d-md-none"><b class="text-primary">30 Tage Geld-zurück-Garantie!</b>

## Alle erleichternden Funktionen für Ihren Praxisalltag verfügbar.
...
<ul class="list-check">
    ...
    <li>Fair-Use Service Flatrate: Alle Änderungen kostenlos über die App und jederzeit per E-Mail</li>
    <li>Support & Änderungen innerhalb 3 Tagen</li>
</ul>
...
<ul class="list-check">
    ...
    <li>Premium Cloud-Services</li>
    <li>Fair-Use Service Flatrate: Alle Änderungen kostenlos über die App und jederzeit per E-Mail</li>
    <li>Support & Änderungen direkt</li>
    <li>Kostenloser Relaunch der Website nach 2 Jahren möglich</li>
</ul>
...
### 1. Kostenloses Erstgespräch, um Ihre Bedürfnisse und Anforderungen zu verstehen
### 2. Individueller Design-Entwurf innerhalb 14 Tagen
### 3. Nach Ihrem Feedback detaillieren wir Schritt-für-Schritt
