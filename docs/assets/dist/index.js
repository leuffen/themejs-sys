...
const embed_1 = __webpack_require__(/*! @kasimirjs/embed */ "./workspaces/kasi-embed/index.ts");
...
const embed_1 = __webpack_require__(/*! @kasimirjs/embed */ "./workspaces/kasi-embed/index.ts");
const embed_2 = __webpack_require__(/*! @kasimirjs/embed */ "./workspaces/kasi-embed/index.ts");
/**
...
/* harmony export */   timeAgo: () => (/* reexport safe */ _src_index__WEBPACK_IMPORTED_MODULE_0__.timeAgo),
/* harmony export */   timeTo: () => (/* reexport safe */ _src_index__WEBPACK_IMPORTED_MODULE_0__.timeTo)
/* harmony export */ });
...
class KaCustomElement extends HTMLElement {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      let domRoot = this;
      if (this.shadowRootConfig.mode !== null && this.shadowRootConfig.mode !== void 0) {
        domRoot = this.attachShadow({ mode: this.shadowRootConfig.mode });
        (_a = this.shadowRootConfig.stylesheets) == null ? void 0 : _a.forEach((stylesheet) => {
...
function template(template2, shadowRootConfig = { mode: null, stylesheets: [] }) {
  return function(classOrDescriptor) {
    classOrDescriptor["html"] = template2;
...
function timeTo(date) {
  const now = new Date();
  let seconds = Math.floor((date.getTime() - now.getTime()) / 1e3);
  if (seconds < 0) {
    return "today";
  }
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("box-price",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("box-prices",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("box-white",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("box-white-container",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("customer-reviews-quote",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("customer-reviews-slider",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("customer-reviews__review",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("filter-image",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("filter-images",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("google-map",
    // language=HTML
    `
...
_leuffen_jodastyle__WEBPACK_IMPORTED_MODULE_0__.Joda.registerTemplate("headline",
    // language=HTML
    `
